...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       DESC
  s.homepage         = "https://github.com/mohammadrhemmati/xmpp-messenger-ios"
  s.license          = 'MIT'
  s.author           = { "ProcessOne" => "mohammadrhemmati@gmail.com" }
  s.source           = { :git => "https://github.com/mohammadrhemmati/xmpp-messenger-ios.git"}
